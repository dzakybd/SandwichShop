...
public class StaticKeys {
    ...
    public static final String CASH_INSUFFICIENT = "cash_insufficient";
    public static final String CARD_INVALID = "card_invalid";
    public static final String CARD_EXPIRED = "card_expired";
    public static final String CARD_WRONG_CVC = "card_wrong_cvc";
